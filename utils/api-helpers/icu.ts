...
const translation = {
  ...
  help: `Навык "Список задач в тудуист" позволяет легко просматривать, создавать, обновлять и закрывать задачи.\n\nПросмотр задач:\nскажите "все задачи", чтобы увидеть полный список. Для просмотра только просроченных, скажите "просроченные задачи". Также можно узнать задачи на определенное время, например, на сегодня, завтра или на какой-то день недели. Для этого скажите "задачи на сегодня" или "задачи на среду".\n\nСоздание задач:\nскажите "создай задачу" и название, например, "создай задачу пропылесосить в комнате". Если вы хотите указать срок, добавьте его в конец запроса, например, "создай задачу пропылесосить в комнате на послезавтра".\n\nОбновление задач:\nскажите "измени название задачи пропылесосить в комнате на пропылесосить в зале", чтобы обновить название.\n\nЗакрытие задач:\nскажите "закрой задачу" и её название, например, "закрой задачу пропылесосить в комнате", чтобы отметить задачу как выполненную.`,
};
